...
final class TogglePasswordTypeExtension extends AbstractTypeExtension
{
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            ...
            'button_classes' => ['absolute', 'inset-y-0', 'right-0', 'flex', 'items-center', 'px-3', 'text-muted-foreground', 'hover:text-foreground', 'transition-colors', 'cursor-pointer'],
            'toggle_container_classes' => ['relative', 'w-full'],
